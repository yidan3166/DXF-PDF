...
//==============================================================================
// $Header: /cvsroot/ycad/ycad/src/com/ysystems/ycad/lib/ydxf/YdxfGetEntArc.java,v 1.13 2003/04/14 12:37:55 ekarlo Exp $
// $Log: YdxfGetEntArc.java,v $
// Revision 1.13  2003/04/14 12:37:55  ekarlo
// Update source file header for OSI release.
//
// Revision 1.12  2000/10/17 07:44:30  ekarlo
// Change package paths to lower case.
//
// Revision 1.11  1999-10-21 22:20:12-06  walter
...
// Rearrange package names.
//
// Revision 1.7  1999/02/08  04:58:27  ekarlo
...
public class YdxfGetEntArc
{
     ...
     */
    static public
    void get(YdxfGetBuffer getbfr, YxxfEntArc ent)
    {
        getbfr.get();
        while (true)
        {
            ...
            if (cod == 50)
            {
                ent.entbegang = getbfr.doubleValue();
            } else

            if (cod == 51)
            {
                ent.entendang = getbfr.doubleValue();
            } else
