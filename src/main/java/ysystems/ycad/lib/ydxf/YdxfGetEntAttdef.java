//==============================================================================
// YdxfGetEntAttdef.java
//
// Get ATTDEF from DXF file
//==============================================================================
...
//==============================================================================
// $Header: /cvsroot/ycad/ycad/src/com/ysystems/ycad/lib/ydxf/YdxfGetEntAttdef.java,v 1.8 2003/04/14 12:37:55 ekarlo Exp $
// $Log: YdxfGetEntAttdef.java,v $
// Revision 1.8  2003/04/14 12:37:55  ekarlo
// Update source file header for OSI release.
//
// Revision 1.7  2000/10/17 07:44:30  ekarlo
// Change package paths to lower case.
//
// Revision 1.6  1999-10-21 22:19:37-06  walter
...
public class YdxfGetEntAttdef
{
     ...
     * @param ent The ATTDEF.
     */
    static public
    void get(YdxfGetBuffer getbfr, YxxfEntAttdef ent)
    {
        getbfr.get();
        while (true)
        {
